import { KLineChartPro, DefaultDatafeed } from '@klinecharts/noob'

export default function setupApp (root: HTMLDivElement) {
  let locale = 'en-US'
  if (window.location.hash.endsWith('#zh-CN')) {
    locale = 'zh-CN'
  }
  root.innerHTML = `
